   ...
   )
{
   ...
   /* include evolutionary algorithm heuristic */
   SCIP_CALL( SCIPincludeObjHeur(scip, new HeurEA(scip), TRUE) );
   ...
   /* Run SCIP */
   SCIP_CALL( SCIPprocessShellArguments(scip, argc, argv, "scip_ea_heur.set") );
